...
<center>
    ...
    <form method="post">
        <table border="0">
            ...
            <tr>
                <td> Date de publication de l'offre </td>
            ...
            <tr>
                <td> statut de l'offre </td>
                <td>
                    <select id="monselect">
                        <option value="valeur1">Expiré</option>
                        <option value="valeur2" selected>En attente de publication</option>
                        <option value="valeur3">publiée</option>
                    </select>
                </td>
            </tr>
            <tr>
    ...
    <form method="post">
        Rechercher une offre: <input type="text" name="mot">
    ...
    <table border="1">
        <tr>
            <td> Id Offre </td> <td> Titre Offre </td>
            <td> Description Offre </td> <td> Date de Pub Offre </td>
            <td> Remuneration </td> <td> Date debut du contrat  </td>
            <td> duree du contrat </td> <td> Statu de l'Offre </td>
            <td> Operation </td>
        </tr>
        <tr>
            <td> value</td>
